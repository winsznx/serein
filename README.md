...
A sum only hides its parts when there are enough of them. With one saver it *is* that saver's weight;
...
Draw #1 exercised the zero-weight path: all three deposits landed 120 seconds *after* its window
